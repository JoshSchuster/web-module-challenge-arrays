...
let partialOriginalFlavors = ["Banana Nut Fudge",
"Black Walnut",
"Burgundy Cherry",
"Butterscotch Ribbon",
"Cherry Macaron",
...
console.log(is31Flavors(partialOriginalFlavors)); //test for false
...
function getFlavorByIndex(arrayPullingFrom, i){

    return arrayPullingFrom[i];
}

console.log(getFlavorByIndex(originalFlavors, 2)); //test
...
function removeFlavorByName(arrayRemovingFrom, flavor){

    for(let i = 0; i < (arrayRemovingFrom.length); i++){
        if(flavor === arrayRemovingFrom[i]){
            arrayRemovingFrom.splice(i,1);
        }
    }
    return arrayRemovingFrom;
}

console.log(removeFlavorByName(originalFlavors, "Vanilla")); //test
...
const newArray = [];
console.log(copy(newArray, originalFlavors)); //test
...
function filterByWord(arraySearching, flavor){

    const returnArray = [];
    for(let i = 0; i < arraySearching.length; i++){
        if(arraySearching[i].includes(flavor)){
            returnArray.push(arraySearching[i]);
        }
    }
    return returnArray;
}

console.log(filterByWord(originalFlavors, "Chocolate")); //test
